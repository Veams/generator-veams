 ...
 * [grunt-connect-proxy](https://github.com/drewzboto/grunt-connect-proxy) a proxy for developing clientside API interfaces in your prototype, with CORS, Basic Authentication support and http methods
